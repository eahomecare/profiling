...
export class ProfileTypeCustomerMappingController {
    constructor(private readonly profileTypeCustomerMappingService: ProfileTypeCustomerMappingService) { }

    @Post()
    create(@Body() data: ProfileTypeCustomerMapping) {
        return this.profileTypeCustomerMappingService.create(data);
    }
    ...
    update(@Param('id') id: string, @Body() data: ProfileTypeCustomerMapping) {
        return this.profileTypeCustomerMappingService.update(id, data);
    }

    @Delete(':id')
    remove(@Param('id') id: string) {
        return this.profileTypeCustomerMappingService.remove(id);
    }
    ...
    async getCustomersByAgeRangeForProfileTypeCustomerMappings(@Param('ageRange') ageRange: string) {
        return this.profileTypeCustomerMappingService.getCustomersByAgeRangeForProfileTypeCustomerMappings(ageRange);
    }
